...
import os
os.chdir(r"C:/Users/gauthambekal93/Research/rl_generalization_exps/rl_procgen_games/Experiment_V3")

model_path =r"C:/Users/gauthambekal93/Research/rl_generalization_exps/rl_procgen_games/Experiment_V3/Models"

result_path =r"C:/Users/gauthambekal93/Research/rl_generalization_exps/rl_procgen_games/Experiment_V3/Results"
...
def main():
        ...
        data = pd.read_csv ( os.path.join(result_path,"Results_v1.csv") )
        ...
        while time_step <= total_timesteps:    
            ...
            with open(os.path.join(result_path, "Results_v1.csv"), 'a', newline='') as file:
