...
def main():
    ...
    try:
        ...
        num_envs = 20 #10 #was 20 #worked with one or 2 envs till now
        ...
        total_reward = 0
        row = pd.read_csv("C:/Users/gauthambekal93/Research/rl_generalization_exps/rl_procgen_games/Results.csv")
        ...
        test_model(actor, critic, time_step, envs_test )
         
        #for sample_phase in tqdm(range(n_updates)):
        #for sample_phase in range(total_timesteps):    
        ...
        while time_step <= total_timesteps:    
            ...
            for step in range(n_steps_per_update):
                ...
                if time_step % logging_rate  == 0: #True: #time_step % 1000 == 0 :
                    ...
                    with open("Results.csv",'a',newline='') as file:
                        ...
                        writer.writerow([ "Train - Datasize: {0} ".format(logging_rate) , str(time_step) , str(total_reward), str(total_reward / logging_rate) ]  )  
                    ...
                    #print("Time steps: {0} Reward rate : {1} ".format(time_step ,  total_reward / time_step  ) )
            ...
            save_model(actor, critic, optimizer)
