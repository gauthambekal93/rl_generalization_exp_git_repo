...
env = gym.make("procgen:procgen-coinrun-v0", start_level=10000, num_levels=num_levels, distribution_mode="easy", use_sequential_levels=True)
...
while time_step <= total_timesteps:   
      ...
      curiosity_loss, rewards = curiosity_model( states, next_states, action)
